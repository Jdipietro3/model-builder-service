  ...
  return (
    <main className="flex flex-1 flex-col items-center px-6 py-16">
      <div className="w-full max-w-2xl">
        <div className="mb-10">
          <h1 className="text-3xl font-semibold tracking-tight">Model Builder</h1>
        ...
        <div className="mb-10 flex gap-2">
          <input
            ...
            className="flex-1 rounded-lg border border-zinc-800 bg-zinc-900 px-4 py-2.5 text-sm outline-none placeholder:text-zinc-500 focus:border-emerald-600"
          />
          <button
            onClick={create}
              ...
              {projects.map((p) => (
                <li key={p.id}>
                  <button
                    ...
                    className="flex w-full items-center justify-between bg-zinc-900/60 px-4 py-3 text-left transition-colors hover:bg-zinc-900"
                  >
