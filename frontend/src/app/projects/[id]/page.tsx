  ...
  return (
    <div className="flex items-end gap-2">
      ...
      <textarea
        ...
        className="focus-ring max-h-40 min-h-10 flex-1 resize-y rounded-lg border border-zinc-800 bg-zinc-900 px-4 py-2.5 text-sm outline-none placeholder:text-zinc-400 focus:border-emerald-600"
      />
      <button
        onClick={onSend}
        disabled={busy || !input.trim()}
        className="focus-ring h-10 rounded-lg bg-emerald-600 px-4 text-sm font-medium text-white transition-colors hover:bg-emerald-500 disabled:opacity-40"
      >
        Send
      </button>
    </div>
    ...
    return (
      <main className="flex h-screen flex-col">
        <header className="flex shrink-0 items-center gap-3 border-b border-zinc-800 px-6 py-3.5">
          <Link
            href="/"
            className="focus-ring rounded text-sm text-zinc-400 transition-colors hover:text-zinc-300"
          >
            ← Projects
          </Link>
          <h1 className="text-display font-semibold text-zinc-100">{project?.name ?? "…"}</h1>
        </header>
        <div className="flex min-h-0 flex-1">
          ...
          <aside className="flex w-95 shrink-0 flex-col border-l border-zinc-800 bg-zinc-950">
            <div className="border-b border-zinc-800 px-4 py-2.5 text-xs font-medium uppercase tracking-wide text-zinc-400">
              Assistant
            </div>
  ...
  return (
    <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col px-4">
      <header className="sticky top-0 z-10 flex items-center gap-3 border-b border-zinc-800 bg-zinc-950/90 py-4 backdrop-blur">
        ...
        <h1 className="text-headline font-semibold text-zinc-100">{project?.name ?? "…"}</h1>
      </header>
